...
#define STRING_CONFIG_H_AUTHOR "Peter2.2" 
...
#define CUSTOM_MENDEL_NAME "UM v2.3"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 150}   //Extruder amount
